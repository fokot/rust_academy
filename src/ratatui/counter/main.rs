...
impl App {
    ...
    fn handle_events(&mut self) -> Result<()> {
        // event::read function blocks until there is an event otherwise use event::poll
        match event::read()? {
...
/*
alternate screen - secondary buffer that allows the application to avoid messing up the user’s current shell
raw mode - the app can process keys immediately without having to wait for a newline
 */
/*
 To get full error messages
 RUST_BACKTRACE=full cargo run --bin counter
 */
fn main() -> Result<()> {
